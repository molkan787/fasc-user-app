...
try {
	var contents = fs.readFileSync("platforms/android/res/values/facebookconnect.xml").toString()
	fs.writeFileSync("platforms/android/res/values/facebookconnect.xml", contents.replace('<bool name="fb_hybrid_app_events">undefined</bool>', ''))
} catch(err) {}